...
def analyze_gaze_chunk_from_path(video_path: str, l_offset: float, r_offset: float, sample_interval=5):
    results_list = []
        ...
        while True:
            ...
            if frame_idx % sample_interval == 0:
                ...
                if result.multi_face_landmarks:
                    ...
                    results_list.append("camera" if avg_diff < GAZE_THRESHOLD else "screen")
...
def analyze_gaze_chunk(video_data_base64, l_offset, r_offset, sample_interval=5):
    ...
    try:
        with open(temp_path, "wb") as f:
            f.write(video_bytes)
        return analyze_gaze_chunk_from_path(temp_path, l_offset, r_offset, sample_interval)
    finally:
